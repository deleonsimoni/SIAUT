.class final Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 31
    const-class v0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->TAG:Ljava/lang/String;
    ...
    sput-object v0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->COMMA_PATTERN:Ljava/util/regex/Pattern;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 42
    iput-object p1, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->context:Landroid/content/Context;
...
.method private static findBestMotZoomValue(Ljava/lang/CharSequence;I)I
    ...
    sget-object v6, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->COMMA_PATTERN:Ljava/util/regex/Pattern;
...
.method private static findBestPreviewSizeValue(Ljava/lang/CharSequence;Landroid/graphics/Point;)Landroid/graphics/Point;
    ...
    .line 121
    .local v3, "diff":I
    sget-object v10, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->COMMA_PATTERN:Ljava/util/regex/Pattern;
    ...
    .line 126
    sget-object v13, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->TAG:Ljava/lang/String;
...
.method private static getCameraResolution(Landroid/hardware/Camera$Parameters;Landroid/graphics/Point;)Landroid/graphics/Point;
    ...
    .line 102
    sget-object v2, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->TAG:Ljava/lang/String;
    ...
    .line 103
    invoke-static {v1, p1}, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->findBestPreviewSizeValue(Ljava/lang/CharSequence;Landroid/graphics/Point;)Landroid/graphics/Point;
...
.method private setFlash(Landroid/hardware/Camera$Parameters;)V
    ...
    sget v0, Ljim/h/common/android/zxinglib/camera/CameraManager;->SDK_INT:I
...
.method private setZoom(Landroid/hardware/Camera$Parameters;)V
    ...
    .line 223
    invoke-static {v6, v9}, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->findBestMotZoomValue(Ljava/lang/CharSequence;I)I
...
.method getCameraResolution()Landroid/graphics/Point;
    ...
    .prologue
    .line 77
    iget-object v0, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->cameraResolution:Landroid/graphics/Point;
...
.method getPreviewFormat()I
    ...
    .prologue
    .line 85
    iget v0, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->previewFormat:I
...
.method getPreviewFormatString()Ljava/lang/String;
    ...
    .prologue
    .line 89
    iget-object v0, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->previewFormatString:Ljava/lang/String;
...
.method getScreenResolution()Landroid/graphics/Point;
    ...
    .prologue
    .line 81
    iget-object v0, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->screenResolution:Landroid/graphics/Point;
...
.method initFromCameraParameters(Landroid/hardware/Camera;)V
    ...
    iput v3, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->previewFormat:I
    ...
    iput-object v3, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->previewFormatString:Ljava/lang/String;

    .line 52
    sget-object v3, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->TAG:Ljava/lang/String;
    ...
    iget v5, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->previewFormat:I
    ...
    iget-object v5, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->previewFormatString:Ljava/lang/String;
    ...
    .line 53
    iget-object v3, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->context:Landroid/content/Context;
    ...
    iput-object v3, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->screenResolution:Landroid/graphics/Point;
    ...
    iget-object v5, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->screenResolution:Landroid/graphics/Point;
    ...
    .line 57
    iget-object v3, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->screenResolution:Landroid/graphics/Point;

    invoke-static {v2, v3}, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->getCameraResolution(Landroid/hardware/Camera$Parameters;Landroid/graphics/Point;)Landroid/graphics/Point;

    move-result-object v3

    iput-object v3, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->cameraResolution:Landroid/graphics/Point;
    ...
    iget-object v5, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->cameraResolution:Landroid/graphics/Point;
...
.method setDesiredCameraParameters(Landroid/hardware/Camera;)V
    ...
    sget-object v1, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->TAG:Ljava/lang/String;
    ...
    iget-object v3, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->cameraResolution:Landroid/graphics/Point;
    ...
    .line 70
    iget-object v1, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->cameraResolution:Landroid/graphics/Point;

    iget v1, v1, Landroid/graphics/Point;->x:I

    iget-object v2, p0, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->cameraResolution:Landroid/graphics/Point;
    ...
    .line 71
    invoke-direct {p0, v0}, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->setFlash(Landroid/hardware/Camera$Parameters;)V

    .line 72
    invoke-direct {p0, v0}, Ljim/h/common/android/zxinglib/camera/CameraConfigurationManager;->setZoom(Landroid/hardware/Camera$Parameters;)V
